...
console.log("The two array of with each teams team members");
const {
  players: [players1, players2],
} = game;
console.log(players1, players2);

console.log("The goalkeeper and the rest of the players as field players");
